function [bestacc,bestc,bestg] = r_SVMcgForClass(train_label,train,cmin,cmax,gmin,gmax,v,cstep,gstep,accstep)
...
% secondline = ['Best c=',num2str(bestc),' g=',num2str(bestg),'CVAccuracy=',num2str(bestacc),'%'];

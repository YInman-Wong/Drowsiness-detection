function [TrainingAccuracy,TestingAccuracy, performance_time] = elm(Xsampledata, Xgroup, Csampledata, Cgroup, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
    % Input:
    %Xsampledata，Xgroup: training data and class label(行向量)
    %Csampledata, Cgroup: testing data and class label（行向量）
